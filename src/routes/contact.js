                        ...
                        <fieldset>
                            <div className="contact-form__checkbox">
                                ...
                                <label htmlFor="privacy">
                                    I hereby consent to the processing of the personal data that I have provided and declare that you should delede them ASAP or prepare to be assimilated by Borgs <FontAwesomeIcon icon="fa-solid fa-cube" />.
                                </label>
                            </div>
                        </fieldset>
